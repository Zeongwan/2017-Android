...
public class addActivity extends AppCompatActivity {
    ...
    private void findId() {
        ...
        addName = (EditText) findViewById(R.id.nameInput);
        addHome = (EditText) findViewById(R.id.homeInput);
        addIntro = (EditText) findViewById(R.id.introInput);
        addBddate = (EditText) findViewById(R.id.bdDateInput);
        addMale = (RadioButton) findViewById(R.id.male);
        addFemale = (RadioButton) findViewById(R.id.female);
        addSexElse = (RadioButton) findViewById(R.id.sexElse);
        addShu = (RadioButton) findViewById(R.id.shu);
        addWu = (RadioButton) findViewById(R.id.wu);
        addWei = (RadioButton) findViewById(R.id.wei);
        addDonghan = (RadioButton) findViewById(R.id.donghan);
        addNationElse = (RadioButton) findViewById(R.id.elseNation);
        sexGroup = (RadioGroup) findViewById(R.id.radioSex);
        nationGroup = (RadioGroup) findViewById(R.id.radioNations);
        makeAdd = (Button) findViewById(R.id.makeAdd);
